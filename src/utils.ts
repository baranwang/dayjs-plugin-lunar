...
export const verifyLunar = (
  ...
  if (year < -1 || year > 9999) {
    throw new Error(
      `Invalid lunar year: ${year}. Valid range is from -1 to 9999.`,
    );
  }
  ...
  if (hour < 0 || hour > 23) {
    throw new Error(
      `Invalid lunar hour: ${hour}. Valid range is from 0 to 23.`,
    );
  }
  ...
  if (minute < 0 || minute > 59) {
    throw new Error(
      `Invalid lunar minute: ${minute}. Valid range is from 0 to 59.`,
    );
  }
  ...
  if (second < 0 || second > 59) {
    throw new Error(
      `Invalid lunar second: ${second}. Valid range is from 0 to 59.`,
    );
  }
};
